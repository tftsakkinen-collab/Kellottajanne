  ...
  return (
    <div className="bg-slate-900/90 border border-slate-800/90 backdrop-blur-xl rounded-3xl p-5 sm:p-7 shadow-2xl shadow-slate-950/40 space-y-6">
      ...
      <div className="flex items-center gap-3 pb-4 border-b border-slate-800/80">
        ...
        <div>
          <h3 className="text-lg font-bold text-white tracking-wide">{t.testSettingsTitle}</h3>
          <p className="text-xs text-slate-400">Harvard Step Test Inputs</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
          <button
            ...
            className={`px-4 py-3 rounded-2xl border text-left text-xs sm:text-sm font-medium transition-all cursor-pointer min-h-[48px] ${
          ...
          <div className="relative">
            <input
              ...
              className={`w-full min-h-[48px] bg-slate-950/80 border rounded-2xl px-3.5 py-3 text-xs sm:text-sm text-slate-100 placeholder-slate-600 focus:outline-none focus:border-teal-500 transition-all ${
                hrState.durationSeconds !== 300 ? 'border-teal-500 text-teal-300 font-semibold' : 'border-slate-800/80'
              }`}
            />
            {hrState.durationSeconds !== 300 && (
              <span className="absolute right-3.5 top-3.5 text-xs text-teal-400 font-mono">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
          ...
          >
            <div className="font-bold text-sm text-slate-200 mb-0.5">{t.formulaLong}</div>
            <div className="text-[11px] text-slate-400 leading-tight">{t.formulaLongSub}</div>
          </button>
          ...
          >
            <div className="font-bold text-sm text-slate-200 mb-0.5">{t.formulaShort}</div>
            <div className="text-[11px] text-slate-400 leading-tight">{t.formulaShortSub}</div>
          </button>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-slate-950/80 border border-slate-800/80 rounded-2xl px-4 py-3 text-sm text-slate-100 placeholder-slate-600 focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 transition-all font-mono min-h-[48px]"
            />
            <span className="absolute right-3.5 top-3.5 text-xs text-slate-500 font-sans pointer-events-none">
